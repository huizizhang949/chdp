...
To implement consensus clustering, first choose the width (number of chains) and depth (length of each chain). Below is an example of running consensus clustering, with 50 chains and 200 iterations on 8 cores
...
And further we can compute posterior mean and highest posterior density (HPD) interval for mean latent count as a function of covariate.
