...
knitr::include_graphics("demo/figures/plot_consensus.png")
```
...
knitr::include_graphics(c("demo/figures/psm_all_nb.png","demo/figures/psm_single_nb.png"))
```
...
```{r, include=TRUE, fig.align="center", echo=FALSE, out.width = "60%", imgcenter=TRUE}
knitr::include_graphics("demo/figures/cluster_size_nb.png")
```
...
knitr::include_graphics(c("demo/figures/plot_c_prob_nb1.png","demo/figures/plot_c_prob_nb2.png"))
```
...
```{r, echo=FALSE,out.width="49%", out.height="20%",fig.show='hold',fig.align='center', imgcenter=TRUE}
knitr::include_graphics(c("demo/figures/plot_pp_mean_nb1.png","demo/figures/plot_pp_mean_nb2.png"))
```
...
```{r, echo=FALSE,out.width="49%", out.height="20%",fig.show='hold',fig.align='center', imgcenter=TRUE}
knitr::include_graphics(c("demo/figures/mean_latent_count_nb1.png","demo/figures/mean_latent_count_nb2.png"))
```
...
```{r, include=TRUE, fig.align="center", echo=FALSE, out.width = "60%", imgcenter=TRUE}
knitr::include_graphics("demo/figures/tsne_nb.png")
```
...
```{r, include=TRUE, fig.align="center", echo=FALSE, out.width = "60%", imgcenter=TRUE}
knitr::include_graphics("demo/figures/global_nb.png")
```
...
knitr::include_graphics(c("demo/figures/DE_global.png","demo/figures/DD_global.png"))
knitr::include_graphics(c("demo/figures/DE_relative.png","demo/figures/DD_relative.png"))
```
...
```{r, include=TRUE, fig.align="center", echo=FALSE, out.width = "60%", imgcenter=TRUE}
knitr::include_graphics("demo/figures/obs_heatmap.png")
```
...
```{r, include=TRUE, fig.align="center", echo=FALSE, out.width = "60%", imgcenter=TRUE}
knitr::include_graphics("demo/figures/latent_heatmap.png")
```
...
```{r, include=TRUE, fig.align="center", echo=FALSE, out.width = "60%", imgcenter=TRUE}
knitr::include_graphics(c("demo/figures/ppc_single_nb1.png","demo/figures/ppc_single_nb2.png"))
```
...
```{r, include=TRUE, fig.align="center", echo=FALSE, out.width = "60%", imgcenter=TRUE}
knitr::include_graphics(c("demo/figures/ppc_multiple_nb1.png","demo/figures/ppc_multiple_nb2.png"))
```


Finally, posterior predictive p-values are also possible to compute from the following functions
...
```{r, echo=FALSE,out.width="49%", out.height="20%",fig.cap=" ",fig.show='hold',fig.align='center', imgcenter=TRUE}
knitr::include_graphics(c("demo/figures/psm_all_var.png","demo/figures/psm_single_var.png"))
```
...
```{r, include=TRUE, fig.align="center", echo=FALSE, out.width = "60%", imgcenter=TRUE}
knitr::include_graphics("demo/figures/cluster_size_var.png")
```
...
```{r, include=TRUE, fig.align="center", echo=FALSE, out.width = "60%", imgcenter=TRUE}
knitr::include_graphics("demo/figures/plot_cluster_var.png")
```
...
```{r, echo=FALSE,out.width="49%", out.height="20%",fig.show='hold',fig.align='center', imgcenter=TRUE}
knitr::include_graphics(c("demo/figures/plot_c_prob_var1.png","demo/figures/plot_c_prob_var2.png"))
```
...
```{r, include=TRUE, fig.align="center", echo=FALSE, out.width = "60%", imgcenter=TRUE}
knitr::include_graphics("demo/figures/plot_conditional_mean.png")
```
...
knitr::include_graphics(c("demo/figures/plot_pred_trend1.png","demo/figures/plot_pred_trend2.png"))
```
...
knitr::include_graphics("demo/figures/plot_pred_c_prob.png")
```

## Posterior predictive check

For multiple replicated datasets, we compare the mean and credible intervals of the replicats with the observed data
...
```{r, echo=FALSE,out.width="49%", out.height="20%",fig.show='hold',fig.align='center',fig.cap=' ', imgcenter=TRUE}
knitr::include_graphics(c("demo/figures/plot_ppc_var1.png","demo/figures/plot_ppc_var2.png"))
```
