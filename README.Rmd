...
```{r, echo=FALSE,out.width="40%", out.height="20%",fig.show='hold',fig.align='center',fig.cap=' '}
...
```{r, echo=FALSE,out.width="49%", out.height="20%",fig.show='hold',fig.align='center',fig.cap=' '}
